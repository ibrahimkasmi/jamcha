...
export function NewsletterForm() {
  ...
  return (
    <div className="bg-gradient-to-br from-primary to-blue-600 text-white p-6 rounded-xl">
      <h3 className="text-xl font-bold mb-2">{t('newsletter.title')}</h3>
      <p className="text-blue-100 mb-4">{t('newsletter.description')}</p>
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        >
          {subscribeMutation.isPending ? t('common.loading') : t('common.subscribe')}
        </Button>
      </form>
    </div>
  );
