...
import { Search, Menu, Moon, Sun, Globe, ChevronDown } from "lucide-react";
...
const HeaderActions = () => {
  const { theme, toggleTheme, setMobileMenuOpen, setSearchOverlayOpen } =
    useStore();
...
import talyinDark from "@/assets/talyin_dark.png";
import talyinWhite from "@/assets/talyin_light.png";

export function Header() {
  // Logo component inside Header to access t
  const Logo = () => {
    const { theme } = useStore();
    const logoSrc = theme === "light" ? talyinDark : talyinWhite;
  ...
  return (
    <header className="bg-white dark:bg-black shadow-sm border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50 overflow-hidden transition-colors duration-500">
